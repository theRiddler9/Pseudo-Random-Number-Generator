...
set proj_dir    [file join $repo_root hardware build vivado_project]
set ip_repo_dir [file join $repo_root hardware ip_repo]
set board_part  "tul.com.tw:pynq-z2:part0:1.0"

# ---- 1. Package the custom IP if component.xml is not present ----
set ip_component [file join $repo_root hardware ip_repo rule30_axi_v1_0 component.xml]
if {![file exists $ip_component]} {
    source [file join $script_dir package_rule30_ip.tcl]
}
...
# ---- 5. Add Zynq PS and run board-specific automation ----
create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 processing_system7_0
apply_bd_automation -rule xilinx.com:bd_rule:processing_system7 \
    -config {make_external "FIXED_IO, DDR" apply_board_preset "1"} \
    [get_bd_cells processing_system7_0]

# ---- 6. Add the custom Rule 30 AXI IP ----
...
# ---- 7. Auto-connect AXI interconnect + reset ----
apply_bd_automation -rule xilinx.com:bd_rule:axi4 \
    -config { Master "/processing_system7_0/M_AXI_GP0" Clk "Auto" } \
    [get_bd_intf_pins rule30_axi_0/s00_axi]

# ---- 8. Validate and generate wrapper ----
...
# ---- 9. Add constraints (only needed if you expose PL pins e.g. LEDs) ----
add_files -fileset constrs_1 [file join $repo_root hardware constraints pynq_z2.xdc]

# ---- 10. Run synthesis, implementation, bitstream ----
launch_runs synth_1 -jobs 4
wait_on_run synth_1
launch_runs impl_1 -to_step write_bitstream -jobs 4
wait_on_run impl_1

# ---- 11. Copy out .bit and .hwh with matching names for PYNQ ----
file mkdir [file join $repo_root hardware build output]
file copy -force \
    [file join $proj_dir $proj_name.runs impl_1 system_wrapper.bit] \
    [file join $repo_root hardware build output rule30_prng.bit]
file copy -force \
    [file join $proj_dir $proj_name.gen sources_1 bd system hw_handoff system.hwh] \
    [file join $repo_root hardware build output rule30_prng.hwh]
